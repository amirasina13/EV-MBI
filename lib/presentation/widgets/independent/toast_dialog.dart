    ...
    child: Row(
      children: [
        Container(
          ...
          child: Icon(Icons.close, color: colorRed, size: 20),
        ),
        Expanded(
          child: Container(
  ...
  Widget toast = Container(
    ...
    child: Row(
      children: [
        Container(
          decoration: BoxDecoration(shape: BoxShape.circle, color: colorWhite),
          child: Icon(Icons.check, color: Color(0xFF04CA53), size: 20),
        ),
        Expanded(
          child: Container(
            margin: EdgeInsets.only(left: 8),
...
void showGeneralToast(String msg, BuildContext context) {
  Widget toast = Container(
    padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 12.0),
    width: MediaQuery.of(context).size.width,
    decoration: BoxDecoration(
    ...
    child: Row(
      children: [
        Container(
          decoration: BoxDecoration(shape: BoxShape.circle, color: colorWhite),
          child: Icon(Icons.error, color: Colors.blue[800], size: 20),
        ),
        Expanded(
          child: Container(
            margin: EdgeInsets.only(left: 8),
